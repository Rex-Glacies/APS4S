...
public class TelaCadastrarFuncionario extends JPanel implements InterfaceCadFuncEClient {
    ...
    public TelaCadastrarFuncionario() {
        ...
        JLabel titulo = new JLabel("Cadastrar Novo Funcionario", SwingConstants.CENTER);
        ...
        formPanel.add(new JLabel("Nome do Funcionario:"));
        ...
        btnEnviar = new JButton("Cadastrar Funcionario");
